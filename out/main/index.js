...
const require$$4$1 = require('fs/promises')
...
const require$$1__default$4 = /*#__PURE__*/ _interopDefaultLegacy(require$$1)
const require$$1__default$2 = /*#__PURE__*/ _interopDefaultLegacy(require$$1$3)
const require$$0__default = /*#__PURE__*/ _interopDefaultLegacy(require$$0)
const require$$0__default$2 = /*#__PURE__*/ _interopDefaultLegacy(require$$0$2)
const require$$1__default = /*#__PURE__*/ _interopDefaultLegacy(require$$1$1)
...
const require$$1__default$1 = /*#__PURE__*/ _interopDefaultLegacy(require$$1$2)
...
const require$$1__default$3 = /*#__PURE__*/ _interopDefaultLegacy(require$$1$4)
const require$$1__default$5 = /*#__PURE__*/ _interopDefaultLegacy(require$$1$5)
...
const windowManagerMap = new Map()
function addWindowManager(instance) {
  windowManagerMap.set(instance.getName(), instance)
}
function getWindowManager(name) {
  return windowManagerMap.get(name)
}
class WindowManager {
  listen() {
    require$$1.ipcMain.handle(this.rename('minimizeWindow'), () => {
      this.windows?.minimize()
    })
    require$$1.ipcMain.handle(this.rename('maxmizeWindow'), () => {
      this.windows?.maximize()
    })
    require$$1.ipcMain.handle(this.rename('unmaximizeWindow'), () => {
      this.windows?.unmaximize()
    })
    require$$1.ipcMain.handle(this.rename('hideWindow'), () => {
      this.windows?.hide()
    })
    require$$1.ipcMain.handle(this.rename('showWindow'), () => {
      this.windows?.show()
    })
    require$$1.ipcMain.handle(this.rename('closeWindow'), () => {
      this.windows?.close()
    })
    require$$1.ipcMain.handle(this.rename('resizable'), () => {
      return this.windows?.isResizable()
    })
    require$$1.ipcMain.handle(this.rename('getPath'), (e, name) => {
...
function assignValue(object, key, value) {
  ...
  if (
    !(hasOwnProperty$6.call(object, key) && eq$4(objValue, value)) ||
...
function baseIsArguments(value) {
  return isObjectLike$1(value) && baseGetTag(value) == argsTag$1
}
...
function assignMergeValue(object, key, value) {
  if (
    (value !== undefined && !eq$4(object[key], value)) ||
    (value === undefined && !(key in object))
  ) {
    baseAssignValue(object, key, value)
  }
...
let _ipcMain = null
function ipcMainInit(instance) {
  _ipcMain = instance
  mainHandlesInit()
}
function mainHandlesInit() {
...
CancellationToken$1.CancellationError = CancellationToken$1.CancellationToken =
  void 0
const events_1 = require$$0__default.default
...
function requireHttpExecutor() {
  ...
  httpExecutor.safeStringifyJson =
    httpExecutor.configureRequestOptions =
    httpExecutor.safeGetHeader =
    httpExecutor.DigestTransform =
    httpExecutor.configureRequestUrl =
    httpExecutor.configureRequestOptionsFromUrl =
    httpExecutor.HttpExecutor =
    httpExecutor.parseJson =
    httpExecutor.HttpError =
    httpExecutor.createHttpError =
      void 0
  const crypto_1 = require$$0__default$2.default
  const debug_1 = browser.exports
  ...
  class HttpError extends Error {
    constructor(
      statusCode,
      message = `HTTP error: ${
        HTTP_STATUS_CODES.get(statusCode) || statusCode
      }`,
      description = null,
    ) {
      super(message)
    ...
    handleResponse(
      ...
      if (debug.enabled) {
        debug(
          ...
          }, request options: ${safeStringifyJson(options)}`,
        )
      }
              ...
              responseHandler: (response, callback) => {
                ...
                response.on('end', () => {
                  if (
                    ...
                    callback(
                      new Error(
                        `Received data length ${position} is not equal to expected ${result.length}`,
                      ),
                    )
                  } else {
                    callback(null)
        ...
        if (response.statusCode >= 400) {
          options.callback(
            new Error(
              ...
              }${requestOptions.path}", status ${response.statusCode}: ${
                response.statusMessage
              }`,
            ),
          )
...
var constants$2 = require$$0__default$3.default
...
var fs$h = require$$1__default.default
...
var debug$2 = noop
if (util$2.debuglog) debug$2 = util$2.debuglog('gfs4')
...
utils$1.checkPath = function checkPath(pth) {
  if (process.platform === 'win32') {
    const pathHasInvalidWinCharacters = /[<>:"|?*]/.test(
      pth.replace(path$g.parse(pth).root, ''),
    )
...
DownloadedUpdateHelper$1.createTempUpdateFile =
  DownloadedUpdateHelper$1.DownloadedUpdateHelper = void 0
const crypto_1 = require$$0__default$2.default
const fs_1$2 = require$$1__default.default
// @ts-ignore
...
class DownloadedUpdateHelper {
  ...
  async validateDownloadedPath(updateFile, updateInfo, fileInfo, logger) {
    if (
      ...
      if (
        ...
        (await fs_extra_1$2.pathExists(updateFile))
      ) {
        return updateFile
      } else {
        return null
  ...
  async getValidCachedUpdateFile(fileInfo, logger) {
    ...
    const doesUpdateInfoFileExist = await fs_extra_1$2.pathExists(
      updateInfoFilePath,
    )
...
function getAppCacheDir() {
  ...
  if (process.platform === 'win32') {
    result =
      process.env['LOCALAPPDATA'] || path$2.join(homedir, 'AppData', 'Local')
...
class ElectronAppAdapter {
  constructor(app = require$$1__default$4.default.app) {
    this.app = app
  }
  whenReady() {
  ...
  get appUpdateConfigPath() {
    return this.isPackaged
      ? path$1.join(process.resourcesPath, 'app-update.yml')
      : path$1.join(this.app.getAppPath(), 'dev-app-update.yml')
  }
  get userDataPath() {
...
;(function (exports) {
  ...
  function getNetSession() {
    return require$$1__default$4.default.session.fromPartition(
      exports.NET_SESSION_NAME,
      {
        cache: false,
      },
  ...
  class ElectronHttpExecutor extends builder_util_runtime_1.HttpExecutor {
    ...
    createRequest(options, callback) {
      ...
      const request = require$$1__default$4.default.net.request({
        ...options,
...
Provider$1.resolveFiles =
  Provider$1.getFileList =
  Provider$1.parseUpdateInfo =
  Provider$1.findFile =
  Provider$1.Provider =
    void 0
const builder_util_runtime_1$b = requireOut()
...
class Provider {
  ...
  createRequestOptions(url, headers) {
    ...
    builder_util_runtime_1$b.configureRequestUrl(url, result)
    return result
  }
}
...
function findFile(files, extension, not) {
  if (files.length === 0) {
    throw builder_util_runtime_1$b.newError(
      'No files provided',
...
function getFileList(updateInfo) {
  ...
  if (updateInfo.path != null) {
    ...
    throw builder_util_runtime_1$b.newError(
      `No files provided: ${builder_util_runtime_1$b.safeStringifyJson(
        updateInfo,
      )}`,
      'ERR_UPDATER_NO_FILES_PROVIDED',
    )
...
function resolveFiles(updateInfo, baseUrl, pathTransformer = p => p) {
  ...
  const result = files.map(fileInfo => {
    if (fileInfo.sha2 == null && fileInfo.sha512 == null) {
      throw builder_util_runtime_1$b.newError(
        `Update info doesn't contain nor sha256 neither sha512 checksum: ${builder_util_runtime_1$b.safeStringifyJson(
          fileInfo,
        )}`,
  ...
  if (packageInfo != null) {
    result[0].packageInfo = {
      ...packageInfo,
      path: util_1$6.newUrlFromBase(pathTransformer(packageInfo.path), baseUrl)
        .href,
    }
  }
  return result
...
class GenericProvider extends Provider_1$5.Provider {
  ...
  async getLatestVersion() {
    ...
    const channelUrl = util_1$5.newUrlFromBase(
      channelFile,
      this.baseUrl,
    ...
    for (let attemptNumber = 0; ; attemptNumber++) {
      try {
        return Provider_1$5.parseUpdateInfo(
        ...
        if (
          e instanceof builder_util_runtime_1$a.HttpError &&
          e.statusCode === 404
        ) {
          throw builder_util_runtime_1$a.newError(
  ...
  resolveFiles(updateInfo) {
    return Provider_1$5.resolveFiles(updateInfo, this.baseUrl)
  }
}
...
const httpExecutor_1 = requireHttpExecutor()
class BintrayClient {
  constructor(options, httpExecutor, cancellationToken, apiKey) {
    ...
    this.auth =
      apiKey == null
        ? null
        : `Basic ${Buffer.from(`${this.user}:${apiKey}`).toString('base64')}`
  ...
  bintrayRequest(path, auth, data = null, cancellationToken, method) {
    return httpExecutor_1.parseJson(
      this.httpExecutor.request(
        httpExecutor_1.configureRequestOptions(
          {
...
class BintrayProvider extends Provider_1$4.Provider {
  constructor(configuration, runtimeOptions) {
    super(runtimeOptions)
    this.client = new bintray_1.BintrayClient(
      configuration,
      runtimeOptions.executor,
      new builder_util_runtime_1$9.CancellationToken(),
    )
    this.baseUrl = util_1$4.newBaseUrl(
  ...
  async getLatestVersion() {
    try {
      ...
      const channelFilename = util_1$4.getChannelFilename(
        this.getDefaultChannelName(),
      )
      const files = await this.client.getVersionFiles(data.name)
      const channelFile = files.find(
        it =>
          it.name.endsWith(`_${channelFilename}`) ||
          it.name.endsWith(`-${channelFilename}`),
      )
      if (channelFile == null) {
        // noinspection ExceptionCaughtLocallyJS
        throw builder_util_runtime_1$9.newError(
      ...
      const channelFileUrl = new url_1$3.URL(
        `https://dl.bintray.com/${this.client.owner}/${this.client.repo}/${channelFile.name}`,
      )
      return Provider_1$4.parseUpdateInfo(
        await this.httpRequest(channelFileUrl),
        channelFilename,
        channelFileUrl,
      )
    } catch (e) {
...
class BitbucketProvider extends Provider_1$3.Provider {
  constructor(configuration, updater, runtimeOptions) {
    ...
    this.baseUrl = util_1$3.newBaseUrl(
  ...
  async getLatestVersion() {
    ...
    const channelFile = util_1$3.getChannelFilename(
      this.getCustomChannelName(this.channel),
    )
    const channelUrl = util_1$3.newUrlFromBase(
      channelFile,
      this.baseUrl,
      this.updater.isAddNoCacheQuery,
    )
    try {
      ...
      throw builder_util_runtime_1$8.newError(
...
GitHubProvider$1.computeReleaseNotes =
  GitHubProvider$1.GitHubProvider =
  GitHubProvider$1.BaseGitHubProvider =
    void 0
...
class BaseGitHubProvider extends Provider_1$2.Provider {
  constructor(options, defaultHost, runtimeOptions) {
    ...
    this.options = options
    this.baseUrl = util_1$2.newBaseUrl(
      builder_util_runtime_1$7.githubUrl(options, defaultHost),
    )
    const apiHost =
      defaultHost === 'github.com' ? 'api.github.com' : defaultHost
    this.baseApiUrl = util_1$2.newBaseUrl(
      builder_util_runtime_1$7.githubUrl(options, apiHost),
    )
  }
  computeGithubBasePath(result) {
    // https://github.com/electron-userland/electron-builder/issues/1903#issuecomment-320881211
    const host = this.options.host
    return host != null && host !== 'github.com' && host !== 'api.github.com'
      ? `/api/v3${result}`
      : result
  }
}
...
class GitHubProvider extends BaseGitHubProvider {
  ...
  async getLatestVersion() {
    ...
    const feedXml = await this.httpRequest(
      util_1$2.newUrlFromBase(`${this.basePath}.atom`, this.baseUrl),
      {
    ...
    try {
      ...
      throw builder_util_runtime_1$7.newError(
    ...
    const channelFile = util_1$2.getChannelFilename(
      this.getDefaultChannelName(),
    )
    const channelFileUrl = util_1$2.newUrlFromBase(
      this.getBaseDownloadPath(tag, channelFile),
      this.baseUrl,
    )
    ...
    try {
      ...
      if (
        ...
        e instanceof builder_util_runtime_1$7.HttpError &&
        e.statusCode === 404
      ) {
        throw builder_util_runtime_1$7.newError(
    ...
    const result = Provider_1$2.parseUpdateInfo(
      rawData,
      channelFile,
      channelFileUrl,
    )
  ...
  async getLatestTagName(cancellationToken) {
    ...
    const url =
      options.host == null || options.host === 'github.com'
        ? util_1$2.newUrlFromBase(`${this.basePath}/latest`, this.baseUrl)
        : new url_1$2.URL(
  ...
  resolveFiles(updateInfo) {
    ...
    return Provider_1$2.resolveFiles(updateInfo, this.baseUrl, p =>
...
class KeygenProvider extends Provider_1$1.Provider {
  constructor(configuration, updater, runtimeOptions) {
    ...
    this.configuration = configuration
    this.updater = updater
    this.baseUrl = util_1$1.newBaseUrl(
  ...
  async getLatestVersion() {
    ...
    const channelFile = util_1$1.getChannelFilename(
      this.getCustomChannelName(this.channel),
    )
    const channelUrl = util_1$1.newUrlFromBase(
      channelFile,
      this.baseUrl,
      this.updater.isAddNoCacheQuery,
    )
    try {
      ...
      throw builder_util_runtime_1$6.newError(
        `Unable to find latest version on ${this.toString()}, please ensure release exists: ${
          e.stack || e.message
        }`,
        'ERR_UPDATER_LATEST_VERSION_NOT_FOUND',
...
class PrivateGitHubProvider extends GitHubProvider_1$1.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    ...
    if (asset == null) {
      ...
      throw builder_util_runtime_1$5.newError(
        `Cannot find ${channelFile} in the release ${
          releaseInfo.html_url || releaseInfo.name
        }`,
        'ERR_UPDATER_CHANNEL_FILE_NOT_FOUND',
      )
    }
    ...
    try {
      ...
      if (
        e instanceof builder_util_runtime_1$5.HttpError &&
        e.statusCode === 404
      ) {
        throw builder_util_runtime_1$5.newError(
          `Cannot find ${channelFile} in the latest release artifacts (${url}): ${
            e.stack || e.message
          }`,
          'ERR_UPDATER_CHANNEL_FILE_NOT_FOUND',
        )
  ...
  resolveFiles(updateInfo) {
    return Provider_1.getFileList(updateInfo).map(it => {
      ...
      if (asset == null) {
        throw builder_util_runtime_1$5.newError(
          `Cannot find asset "${name}" in: ${JSON.stringify(
            updateInfo.assets,
            null,
            2,
          )}`,
...
providerFactory.createClient =
  providerFactory.isUrlProbablySupportMultiRangeRequests = void 0
...
function createClient(data, updater, runtimeOptions) {
  ...
  if (typeof data === 'string') {
    throw builder_util_runtime_1$4.newError(
...
function requireAppUpdater() {
  ...
  class AppUpdater$1 extends events_1.EventEmitter {
    constructor(options, app) {
      ...
      if (currentVersion == null) {
        throw builder_util_runtime_1.newError(
    ...
    checkForUpdatesAndNotify(downloadNotification) {
      ...
      return this.checkForUpdates().then(it => {
        ...
        void downloadPromise.then(() => {
          const notificationContent = AppUpdater$1.formatDownloadNotification(
            it.updateInfo.version,
            this.app.name,
            downloadNotification,
          )
          new require$$1__default$4.default.Notification(
            notificationContent,
          ).show()
        })
        return it
    ...
    async getUpdateInfoAndProvider() {
      ...
      if (this.clientPromise == null) {
        this.clientPromise = this.configOnDisk.value.then(it =>
          providerFactory_1.createClient(
            it,
            this,
    ...
    onUpdateAvailable(updateInfo) {
      this._logger.info(
        `Found version ${updateInfo.version} (url: ${builder_util_runtime_1
          .asArray(updateInfo.files)
          .map(it => it.url)
          .join(', ')})`,
      )
    ...
    downloadUpdate(
      ...
      this._logger.info(
        `Downloading update from ${builder_util_runtime_1
          .asArray(updateInfoAndProvider.info.files)
          .map(it => it.url)
          .join(', ')}`,
      )
      const errorHandler = e => {
        ...
        if (!(e instanceof builder_util_runtime_1.CancellationError)) {
          try {
            ...
            this._logger.warn(
              `Cannot dispatch error event: ${
                nestedError.stack || nestedError
              }`,
            )
          }
        }
    ...
    async loadUpdateConfig() {
      ...
      return js_yaml_1.load(
        await promises_1.readFile(this._appUpdateConfigPath, 'utf-8'),
      )
    }
    ...
    async executeDownload(taskOptions) {
      ...
      const tempUpdateFile =
        await DownloadedUpdateHelper_1.createTempUpdateFile(
          `temp-${updateFileName}`,
          cacheDir,
          log,
        )
...
function requireBaseUpdater() {
  ...
  class BaseUpdater$1 extends AppUpdater_1.AppUpdater {
    constructor(options, app) {
      super(options, app)
    ...
    quitAndInstall(isSilent = false, isForceRunAfter = false) {
      ...
      if (isInstalled) {
        setImmediate(() => {
          ...
          require$$1__default$4.default.autoUpdater.emit(
      ...
      if (
        ...
        throw new Error(
          `operation (block index: ${index}, checksum: ${checksum}, kind: ${
            ...
            `rel: ${lastOperation.start - min} until ${
              lastOperation.end - min
            } and ${operation.start - min} until ${operation.end - min}`,
        )
      }
    }
...
const fs_1$1 = require$$1__default.default
...
class DataSplitter extends stream_1$1.Writable {
  ...
  async handleData(chunk) {
    ...
    if (this.ignoreByteCount !== 0 && this.remainingPartDataCount !== 0) {
      throw builder_util_runtime_1$3.newError(
        'Internal error',
...
multipleRangeDownloader.checkIsRangesSupported =
  multipleRangeDownloader.executeTasksUsingMultipleRangeRequests = void 0
...
function doExecuteTasks(differentialDownloader, options, out, resolve, reject) {
  ...
  if (partCount <= 1) {
    ...
    const w = index => {
      ...
      if (task.kind === downloadPlanBuilder_1$1.OperationKind.COPY) {
        DataSplitter_1$1.copyData(task, out, options.oldFileFd, reject, () =>
          w(index),
        )
      } else {
  ...
  const request = differentialDownloader.httpExecutor.createRequest(
    ...
    response => {
      ...
      const contentType = builder_util_runtime_1$2.safeGetHeader(
        response,
        'content-type',
      )
      const m =
...
function checkIsRangesSupported(response, reject) {
  ...
  if (response.statusCode !== 206) {
    const acceptRanges = builder_util_runtime_1$2.safeGetHeader(
      response,
      'accept-ranges',
    )
...
class ProgressDifferentialDownloadCallbackTransform extends stream_1.Transform {
  ...
  _transform(chunk, encoding, callback) {
    ...
    if (
      now >= this.nextUpdate &&
      this.transferred !==
        this.expectedBytes /* will be emitted by endRangeDownload() */ &&
      this.transferred !==
...
class DifferentialDownloader {
  ...
  doDownload(oldBlockMap, newBlockMap) {
    ...
    const operations = downloadPlanBuilder_1.computeOperations(
      oldBlockMap,
      newBlockMap,
      logger,
    )
  ...
  async doDownloadFile(tasks, fdList) {
    ...
    const fileOut = fs_1.createWriteStream(this.options.newFile, {
      fd: newFileFd,
    })
    await new Promise((resolve, reject) => {
      const streams = []
      ...
      const digestTransform = new builder_util_runtime_1$1.DigestTransform(
      ...
      if (this.options.isUseMultipleRangeRequest) {
        w = multipleRangeDownloader_1.executeTasksUsingMultipleRangeRequests(
          this,
          tasks,
          firstStream,
          oldFileFd,
      ...
      w = index => {
        ...
        request.on('redirect', (statusCode, method, redirectUrl) => {
          ...
          builder_util_runtime_1$1.configureRequestUrl(
  ...
  request(requestOptions, dataHandler) {
    return new Promise((resolve, reject) => {
      const request = this.httpExecutor.createRequest(
        ...
        response => {
          if (
            !multipleRangeDownloader_1.checkIsRangesSupported(response, reject)
          ) {
            return
          }
...
function requireAppImageUpdater() {
  ...
  const main_1 = requireMain()
  const Provider_1 = Provider$1
  class AppImageUpdater$1 extends BaseUpdater_1.BaseUpdater {
    constructor(options, app) {
      super(options, app)
    }
    isUpdaterActive() {
    ...
    doDownloadUpdate(downloadUpdateOptions) {
      ...
      const fileInfo = Provider_1.findFile(
    ...
    doInstall(options) {
      ...
      child_process_1.execFileSync('mv', [
        '-f',
...
function requireMacUpdater() {
  ...
  const Provider_1 = Provider$1
  const child_process_1 = require$$1__default$5.default
  class MacUpdater$1 extends AppUpdater_1.AppUpdater {
    constructor(options, app) {
      super(options, app)
      this.nativeUpdater = require$$1__default$4.default.autoUpdater
    ...
    async doDownloadUpdate(downloadUpdateOptions) {
      ...
      try {
        ...
        const result = child_process_1.execFileSync(
          'sysctl',
      ...
      try {
        ...
        const result = child_process_1.execFileSync('uname', ['-a'], {
          encoding: 'utf8',
        })
      ...
      if (zipFileInfo == null) {
        throw builder_util_runtime_1.newError(
          `ZIP file not provided: ${builder_util_runtime_1.safeStringifyJson(
            files,
          )}`,
    ...
    async updateDownloaded(zipFileInfo, event) {
      ...
      const updateFileSize =
        (_a = zipFileInfo.info.size) !== null && _a !== void 0
          ? _a
          : (await fs_extra_1.stat(downloadedFile)).size
      const log = this._logger
      ...
      return await new Promise((resolve, reject) => {
        ...
        const fileUrl = `/${Date.now().toString(16)}-${Math.floor(
          Math.random() * 9999,
        ).toString(16)}.zip`
        ...
        server.listen(0, '127.0.0.1', () => {
          this.debug(
            `Proxy server for native Squirrel.Mac is listening (address=${getServerUrl()}, ${logContext})`,
          )
    ...
    child_process_1.execFile(
      ...
      (error, stdout, stderr) => {
        try {
          ...
          if (data.Status === 0) {
            const name = builder_util_runtime_1
              .parseDn(data.SignerCertificate.Subject)
              .get('CN')
...
function requireNsisUpdater() {
  ...
  const url_1 = require$$2__default.default
  const zlib_1 = require$$2__default$1.default
  class NsisUpdater$1 extends BaseUpdater_1.BaseUpdater {
    constructor(options, app) {
      super(options, app)
    }
    /*** @private */
    ...
    async verifySignature(tempUpdateFile) {
      ...
      return await windowsExecutableCodeSignatureVerifier_1.verifySignature(
    ...
    async differentialDownloadInstaller(
      ...
      try {
        ...
        const blockmapFileUrls = util_1.blockmapFiles(
          fileInfo.url,
          this.app.version,
...
function handleUpdate() {
  ...
  mainExports.autoUpdater.on('error', function (e) {
    log.warn('error', e)
    sendUpdateMessage({
      cmd: 'error',
  ...
  // 更新下载进度事件
  mainExports.autoUpdater.on('download-progress', function (progressObj) {
    log.warn('触发下载。。。')
...
const baseWindowConfig = {
  windowConfig: {
    ...
    ...(process.platform === 'linux'
      ? {
          icon: require$$1__default$2.default.join(
            __dirname,
            '../../build/icon.png',
          ),
        }
      : {}),
    webPreferences: {
      preload: require$$1__default$2.default.join(
        __dirname,
        '../preload/index.js',
      ),
      webSecurity: true,
...
function createWindow(name, url, config) {
  let windowConfig = undefined
  if (config) {
    if (config.windowConfig) windowConfig = config.windowConfig
  }
  // Create the browser window.
  const window = new require$$1.BrowserWindow(windowConfig)
  ...
  window.webContents.setWindowOpenHandler(details => {
    return {
      action: 'allow',
      overrideBrowserWindowOptions: merge$2(
        {},
        baseWindowConfig,
        details.features,
      ),
  ...
  if (utils$2.is.dev && process.env['ELECTRON_RENDERER_URL']) {
    ...
    window.loadFile(
      require$$1__default$2.default.join(__dirname, '../renderer/index.html'),
      {
        hash: url ?? '',
      },
    )
...
require$$1.app.whenReady().then(() => {
  ...
  createWindow('main', '/main', baseWindowConfig)
...
// 打开窗口监听
require$$1.ipcMain.handle('openWindow', (_, args) => {
  const { name, path, config } = args
  createWindow(name, path, merge$2({}, baseWindowConfig, config))
})
